      ...
      <main>
        ...
        <div className="main-teaser">
          ...
          <div>
            ...
            <br />
            This project makes use of Electron, React, Typescript, Webpack to serve the best environment for development
            with hot-reloading of modules and styles {test}.
          </div>
        </div>
        ...
        <p className="main-teaser small center">
          Click below button(s) to update the application &quot;counter&quot; state. For faster development experience,
          this application will update using Hot Reload without needing to restart/reload after code changes
        </p>
